...
array {
	sound {wavefile { filename="bubapu.wav"; }; description = "16";} my_second;
	sound {wavefile { filename="dipida.wav"; }; description = "17";};
} second;

array {
	sound {wavefile { filename="dabapu.wav"; }; description = "18";} my_wrong;
	sound {wavefile { filename="dobapu.wav"; }; description = "19";};
	sound {wavefile { filename="bapida.wav"; }; description = "20";};
	sound {wavefile { filename="bupida.wav"; }; description = "21";};
} wrong;
...
loop int c = 1 until c > 4 begin # block grouping
      			...
      			elseif pair == 2 then
						...
						elseif count2 == 3  then
							...
							if wrongCounter == 1 then
								...
								event2.set_event_code( code + "WRONG1" );
								event2.set_port_code( 20 );
								second_trial.present();
							elseif wrongCounter == 2 then
								event2.set_stimulus( wrong[4] );
								event2.set_event_code( code + "WRONG2" );
								event2.set_port_code( 21 );
								second_trial.present();
							end;
						end;
      			end;
